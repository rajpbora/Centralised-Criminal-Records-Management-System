...
### Defining the Labels Entries
    status1 = Label(t, text=iy[0][7], font=tkFont.Font(family="Times New Roman", size=16), borderwidth=2, relief="solid")
    case_id1 = Label(t, text=i2[0][0], font=tkFont.Font(family="Times New Roman", size=16), borderwidth=2, relief="solid")
    ps1 = Label(t, text=iy[0][3], font=tkFont.Font(family="Times New Roman", size=16), borderwidth=2, relief="solid")
    od1 = Label(t, text=iy[0][5], font=tkFont.Font(family="Times New Roman", size=16), borderwidth=2, relief="solid")
    cd1 = Label(t, text=iy[0][6], font=tkFont.Font(family="Times New Roman", size=16), borderwidth=2, relief="solid")
    pno1 = Label(t, text=iy[0][1], font=tkFont.Font(family="Times New Roman", size=16), borderwidth=2, relief="solid")
    sn1 = Label(t, text=iy[0][2], font=tkFont.Font(family="Times New Roman", size=16), borderwidth=2, relief="solid")
    desc1 = Label(t, text=iy[0][4], font=tkFont.Font(family="Times New Roman", size=16), borderwidth=2, relief="solid")
...
### Defining the buttons
    ...
    editt = Button(t, text='UPDATE RECORD', font=tkFont.Font(family="Times New Roman", size=16), command=edit,
                     borderwidth=4, relief="solid")
