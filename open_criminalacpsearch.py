...
from open_criminaledit import test1
import datetime
import os
...
### Defining the Labels with entries
    fname1 = Label(t, text=j[0][1]+" "+j[0][2]+" "+j[0][3], font=tkFont.Font(family="Times New Roman", size=18), borderwidth=2, relief="solid",width=15,height=2)
    gender1 = Label(t, text=j[0][8], font=tkFont.Font(family="Times New Roman", size=18), borderwidth=2,
                    relief="solid")
    dob1 = Label(t, text=j[0][4], font=tkFont.Font(family="Times New Roman", size=18), borderwidth=2, relief="solid",width=15,height=2)
